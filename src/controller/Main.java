...
public class Main {
    public static void main (String[] a){
        ...
        //где прикрутить джененрики, где прикрутить стримы, как сделать чтобы консруктр был обверткой декоратор и можно добавлять
        //что хочешь
        // статик переменная вил вейцгт
        //шаблон билдер
        //класс декоратор наследуется от колеса, от него аследуется декорация(одно из полей типа декорируемого объекта)
        //класс характеристики
        //поиск по заданным критеиям
